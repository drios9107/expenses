...
const RecurrentTransaction = ({ initialItems = [], lng, error }) => {
	...
	const { isLoading, deleteRecurrentTransaction, updateRecurrentTransaction } = useRecurrentTransaction()
	...
	useEffect(() => {
		setRecurrentTransactions(initialItems)
	}, [initialItems, setRecurrentTransactions])
