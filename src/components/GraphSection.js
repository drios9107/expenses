...
const GraphSection = ({ isHover1, setIsHover1, currentMonth, currentYear, isHover2, setIsHover2 }) => {
	...
	return (
		<Grid2 container spacing={2}>
			<Grid2 size={{ xs: 12, md: 6 }}>
				...
				>
					<Typography sx={styles.graphTitle}>{t('graphBarTitle')}</Typography>
			...
			<Grid2 size={{ xs: 12, md: 6 }}>
				...
				>
					<Typography sx={styles.graphTitle}>{t('graphPieTitle')}</Typography>
